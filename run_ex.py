...
input=list(itertools.product(*[timewindow_val, hidden_states_val, layers_val]))
random.shuffle(input)

def job(nr, list_commands):
    for i in list_commands:
        os.system("CUDA_VISIBLE_DEVICE={} python run.py --train --e 25 --obs --lb {} --hs {} --nl {} --lf 1 --vp 8895".format(nr, i[0], i[1], i[2] ))
